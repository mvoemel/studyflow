...
public class InMemoryModuleDao implements ModuleDao {
    private final Map<Long, Module> modules = new HashMap<>();
    private final Map<Long, Long> moduleToSemester = new HashMap<>();
    private final Map<Long, Long> semesterToDegree = new HashMap<>();
    private final Map<Long, Long> degreeToUser = new HashMap<>();
